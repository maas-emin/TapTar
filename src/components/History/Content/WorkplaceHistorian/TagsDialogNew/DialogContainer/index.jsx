...
import { closeWorkplaceAffiliationNew } from '../../../../../../redux/ducks/application';
...
function DialogContainer() {
  ...
  const file = useSelector(
    (state) => state.application.workplaceMaterialNew.files,
  );
  ...
  const handleClose = () => {
    dispatch(closeWorkplaceAffiliationNew());
  };
