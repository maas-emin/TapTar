...
function WorkshopDocument({ document }) {
  ...
  return (
    <div className={style.block}>
      <div className={style.file}>
            ...
            onClick={() =>
              history.push({
                pathname: `/history/workshop/master/${
                  document.process_id || document.id
                }`,
        ...
        <div className={style.name}>{document.title}</div>
      </div>
    </div>
  );
}

export default WorkshopDocument;
