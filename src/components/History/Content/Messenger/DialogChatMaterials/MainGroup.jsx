import { getOneImage } from '../../../../../redux/ducks/application';
  ...
  return (
    <>
      <div className={style.groupTitle}>
        <div className={style.groupTitleIcon}>{svg}</div>
        <div className={style.groupTitleText}>{props.title}</div>
      </div>
