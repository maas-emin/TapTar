...
import { closeApproverAffiliation } from '../../../../../../redux/ducks/application';
...
function DialogContainer() {
  ...
  const file = useSelector((state) => state.application.approverMaterial.files);
  ...
  const handleClose = () => {
    dispatch(closeApproverAffiliation());
  };
