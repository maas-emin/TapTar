...
import { getProcessedMaterialsApprover } from '../../../../../../redux/ducks/approver';
import StartPage from '../../../../General/StartPage';

import style from '../materials.module.css';

function ApproverProcessed() {
  ...
  useEffect(() => {
    dispatch(getProcessedMaterialsApprover());
  }, [dispatch, message]);
    ...
    <div className={style.materials}>
      {loading ? (
        ...
        <div className={style.files__header}>
          <div className={style.files__title}>Утвержденные</div>
...
export default ApproverProcessed;
